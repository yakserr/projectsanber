        ...
        <div class=" px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <label class="block text-sm">
                ...
                <input
                    ...
                    placeholder="Your Title" name="title" value="{{ old('title') ?? $question->title }}" />
                @error('title')
            ...
            <div class="my-6">
                <div class="flex justify-start">
                    <div class="mb-3 w-96">
                        ...
                        @if($question->image)
                        <img src="{{ asset('storage/' . $question->image) }}" alt="{{ $question->title }}"
                            class="img-preview w-full h-auto rounded-md shadow-md">
                        @else
                        <img class="img-preview w-full h-auto rounded-md shadow-md">
                        @endif
                        <input
                            class="form-control block w-full px-3 py-1.5 mt-1 text-base font-normal dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
